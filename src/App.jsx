...
function App() {
  ...
  const addCityToDB = async () => {
    ...
    try {
      ...
      const res = await fetch('http://weather-app-backend-ruddy.vercel.app/api/weather/add', {
        method: 'POST',
  ...
  const fetchRecords = async () => {
    try {
      const res = await fetch('http://weather-app-backend-ruddy.vercel.app/weather');
      const data = await res.json();
      setRecords(data);
    } catch (err) {
  ...
  const deleteCity = async (name) => {
    try {
      const res = await fetch(`http://weather-app-backend-ruddy.vercel.app/weather/${encodeURIComponent(name)}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      alert(data.message);
  ...
  const exportToCSV = async () => {
    try {
      const res = await fetch('http://weather-app-backend-ruddy.vercel.app/weather/export/csv');
